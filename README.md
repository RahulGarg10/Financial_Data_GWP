...
| :- | :- | :- |
|1\.Unsecured Loan|<p>- The borrower already has too much debt compared to assets, which may lead to default.</p><p>- In the case of student loans, the employment outcome is leveraged.</p>|- The payoff or full payment of principal depends upon the earnings outcome of student or profit exceeding debt taken by the borrower. So, behaving like an option on equity.|
|2\.Construction Loan|<p>- The borrower already has too much debt compared to assets, which may lead to default.</p><p>- The constructed property will have leverage because it is financed by loan.</p>|- The payoff or full payment of principal depends upon the total debt not exceeding total assets or equity exceeding debt taken by the borrower. So, behaving like an option on equity.|
|3\.Equity|<p>- The borrower may take on too much leverage, which could lead to a default.</p><p>- High-frequency trading strategies have implicit leverage challenges.</p>|<p>- The price of the equity may exhibit nonlinear behavior, such as a fat tail distribution. This could lead to large losses for the lender if the price of the equity declines sharply.</p><p>- Option and derivative positions leading to non-linear payoffs.</p>|
|4\.Bond|<p>- The borrower may take on too much leverage, which could lead to a default</p><p>- Use of bond futures for leverage.</p>|<p>- The price of the bond may exhibit nonlinear behavior, such as a fat tail distribution.</p><p>- Non-linear yield changes due to convexity (here, convexity is the derivative of the price of the bond with respect to interest rates.).</p>|
